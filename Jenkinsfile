...
// variables:
//      https://github.com/rajrroy/events-app-web-server.git
//      main
//      dtcaugust2021-203
//      gcr.io/dtcaugust2021-203/web-server-image
//      cluster-1 
//      asia-east1-a
    ...
    stages {
        stage('Stage 1') {
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/rajrroy/events-app-web-server.git'
        ...
        stage('Stage 2') {
         ...
         stage('Stage 4') {
            steps {
                ...
                sh "gcloud builds submit -t gcr.io/dtcaugust2021-203/gcr.io/dtcaugust2021-203/web-server-image:v2.${env.BUILD_ID} ."
            }
        }        
         stage('Stage 5') {
            steps {
